...
final class EventsList {
    ...
    static var events: [Event] { return EventsList.shared.sharedEvents }
...
//                if parser.parse() {
//                    EventsList.updateList(with: self.results)
//                }
//            }
        }
    }
    
    private static func updateList(with results: [[String: String]]?) {
